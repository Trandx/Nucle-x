...
<nav class="fixed w-full bg-white border-gray-200 px-2 sm:px-4 dark:bg-gray-900">
  ...
  <div class=" mx-5 flex justify-content-left ">

      <div class="flex items-center md:order-2 ">
          <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-12 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" 
            id="user-menu-button">
            <span class="sr-only">Open user menu</span>
            <img class="w-8 h-8 rounded-full" src="../../../assets/logo.png" alt="user photo">
          </button>
          <!-- Dropdown menu -->
          <div class=" hidden z-50 top-10 my-5 text-base list-none bg-primary dark:bg-gray-900 rounded divide-y divide-gray-200 shadow shadow-zinc-100 dark:divide-gray-600 absolute md:top-10 md:my-8 right-5 " 
            ...
            <ul class="py-1" aria-labelledby="user-menu-button">
              <li>
                <router-link :to="{name: 'Clients'}" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Dashboard</router-link>
              </li>
              <li>
      ...
      <div class="sm:absolute sm:z-50 sm:top-10 sm:my-0 sm:right-10 md:relative md:top-0  md:mx-12 justify-between items-center md:flex md:w-auto md:order-1" id="mobile-menu-2">
        <ul class="flex flex-col p-4 mt-2 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <router-link :to="{name: 'Clients'}" class="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Home</router-link>
          </li>
          <li>
